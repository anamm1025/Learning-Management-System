...
void AddTeacher::quitButtonClicked()
{
	this->destroy();
	LMSsystem *one;
...
void AddTeacher::AddTeacherClicked()
{
	...
	if(one->AddTeacher(s,checkGender1,checkGender2)==1)
	{
		ui.errorLabel->setText("Congratulations.Teacher has been successfully added...");
		ui.repasswordError->setText("");
	}
}