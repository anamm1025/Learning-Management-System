...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_selectTest_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 11)
    ...
    "selectTest\0dropClicked\0\0backClicked\0"
};
...
void selectTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        selectTest *_t = static_cast<selectTest *>(_o);
        switch (_id) {
        case 0: _t->dropClicked(); break;
...
const QMetaObject selectTest::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_selectTest.data,
      qt_meta_data_selectTest,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_selectTest.stringdata))
        return static_cast<void*>(const_cast< selectTest*>(this));
